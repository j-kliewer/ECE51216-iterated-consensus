...
Generates all prime implicants(cubes) given a cover to a boolean function.
...
Output is a list of all prime implicants(cubes) printed on stdout

Example: Output of iterated_consensus(cover)
  "ZER DNC DNC ONE
